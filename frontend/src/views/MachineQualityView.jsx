// src/views/MachineQualityView.jsx

import React, { useState, useRef } from "react";
import axios from "axios";
import Webcam from "react-webcam";

const MachineQualityView = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("http://127.0.0.1:8000/predict_machine/", formData, {
      ...
      alert("Something went wrong while detecting machine quality.");
    } finally {
      setLoading(false);
    ...
    <div className="flex flex-col items-center mt-8 p-4 w-full">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-2xl">
        ...
        <p className="text-gray-600 mb-6 text-center">
          Upload an image or video to check machine quality issues or anomalies.
        </p>
...
export default MachineQualityView;
